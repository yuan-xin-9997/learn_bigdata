package org.atguigu.optimize.wordcount;
...
* 1.创建Job实例并运行（在本地运行）
*
* MapReduce优化——IO传输——使用SequenceFile二进制文件
* */
public class WCDriver {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        FileOutputFormat.setOutputPath(job, new Path("D:\\dev\\learn_bigdata\\MRDemo1\\output14"));


        // ===================MapReduce优化——IO传输——使用SequenceFile二进制文件===================
        // 输出的文件是二进制文件，不是给人看的，是作为另外MR任务的输入数据
