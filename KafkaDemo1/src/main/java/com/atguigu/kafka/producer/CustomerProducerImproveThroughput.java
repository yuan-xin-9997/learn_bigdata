 ...
 * 提高生产者搬运数据的吞吐量
 */
public class CustomerProducerImproveThroughput {
...
//        properties.put("value.serializer", StringSerializer.class.getName());
        ...
        // ============================增加吞吐量============================
        properties.put(ProducerConfig.BUFFER_MEMORY_CONFIG, 33554432); // 单位：bytes，=256MB，缓存区大小，RecordAccumluator大小，默认32MB
        properties.put(ProducerConfig.BATCH_SIZE_CONFIG, 16384);//单位：bytes，128KB，批次大小，默认16KB
        properties.put(ProducerConfig.LINGER_MS_CONFIG, 10); // 单位：毫秒，等待时间，默认0ms
        properties.put(ProducerConfig.COMPRESSION_TYPE_CONFIG, "snappy"); // 压缩算法
