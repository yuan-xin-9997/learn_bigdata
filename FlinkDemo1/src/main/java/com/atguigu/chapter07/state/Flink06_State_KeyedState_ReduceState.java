 ...
 * @description: Flink状态-Managed State-Keyed State(键控状态)-ReduceState聚合状态
    ...
    public static void main(String[] Args) {
        ...
        dataStream
                ...
                .process(new KeyedProcessFunction<String, WaterSensor, String>() {
                    private ReducingState<WaterSensor> vcSumState;  // 键控状态成员变量
                        ...
                        vcSumState = getRuntimeContext().getReducingState(new ReducingStateDescriptor<WaterSensor>(
                                ...
                                new ReduceFunction<WaterSensor>() {
                                    ...
                                    public WaterSensor reduce(WaterSensor value1, WaterSensor value2) throws Exception {
                                        ...
                                        System.out.println("reduce");  // 每流入一个元素，函数执行一次
                                        return value1;
                                    }
                                },
                                WaterSensor.class
